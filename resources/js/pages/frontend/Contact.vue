...
import Testimonial from '@/components/frontend/TestimonialSlider.vue';
import { ref } from 'vue'
import Header from '@/components/frontend/Header.vue'
import OffcanvasMenu from '@/components/frontend/OffcanvasMenu.vue'
import Hero from '@/components/frontend/Hero.vue'
import Service from '@/components/frontend/Service.vue'
import About from '@/components/frontend/About.vue'
import Tabs from '@/components/frontend/Tabs.vue'
...
<template>
    <FrontendLayout>
        ...
        <div class="overflow-x-hidden">
            ...
            <section class="bg-white pt-40  pb-[120px]">
                    ...
                    <div class="grid grid-cols-12 gap-6">
                            ...
                            <div class="flex flex-wrap flex-col gap-7">
                                <div class="flex flex-wrap gap-4 pb-4 border-b border-gray-300 lg:max-w-[416px]">
                                    ...
                                    <div class="flex flex-wrap flex-col flex-1">
                                        ...
                                        <h5 class="text-xl font-bold font-Syne text-black-800 leading-7">{{about.email  }}
                                        </h5>
                                    </div>
                                </div>
                                <div class="flex flex-wrap gap-4 pb-4 border-b border-gray-300 lg:max-w-[416px]">
                                    ...
                                    <div class="flex flex-wrap flex-col flex-1">
                                        ...
                                        <h5 class="text-xl font-bold font-Syne text-black-800 leading-7">{{about.phone  }}
                                ...
                                <div class="flex flex-wrap gap-4 pb-4 border-b border-gray-300 lg:max-w-[416px]">
                                    ...
                                    <div class="flex flex-wrap flex-col flex-1">
                                        ...
                                        <h5 class="text-xl font-bold font-Syne text-black-800 leading-7">{{ about.address }}
                                        </h5>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-span-12 lg:col-span-6" data-aos="fade-up" data-aos-delay="300">
                            <form id="contact-form" action="mail.php" method="post"
                                class="grid grid-cols-12 gap-[18px]">
                                <div class="col-span-12 md:col-span-6">
                                    <label class="text-sm font-normal font-Inter leading-tight mb-3 block"
                                        for="name">Name</label>
                                    <input id="name"
                                        class="font-normal w-full leading-7 placeholder:opacity-100 placeholder:text-black-text-600 border border-black-800 border-opacity-40 rounded-[8px] p-4 focus:border-black-800 focus:border-opacity-40 focus:outline-none "
                                ...
                                <div class="col-span-12 md:col-span-6">
                                    ...
                                    <input id="Phone"
                                        class="font-normal w-full leading-7 placeholder:opacity-100 placeholder:text-black-text-600 border border-black-800 border-opacity-40 rounded-[8px] p-4 focus:border-black-800 focus:border-opacity-40 focus:outline-none "
                                        type="text" required placeholder="Your number" name="phone">
                                </div>
                                <div class="col-span-12 md:col-span-6">
                                    <label class="text-sm font-normal font-Inter leading-tight mb-3 block"
                                    ...
                                    <input id="Subject"
                                        class="font-normal w-full leading-7 placeholder:opacity-100 placeholder:text-black-text-600 border border-black-800 border-opacity-40 rounded-[8px] p-4 focus:border-black-800 focus:border-opacity-40 focus:outline-none "
                                        type="text" required placeholder="Your subject*" name="subject">
                                </div>
                                ...
                                <div class="col-span-12">
                                    ...
                                    <textarea
                                        class="h-[100px] font-normal w-full leading-7 placeholder:opacity-100 placeholder:text-black-text-600 border border-black-800 border-opacity-40 rounded-[8px] p-4 focus:border-black-800 focus:border-opacity-40 focus:outline-none resize-none"
                                        name="message" id="Message" cols="30" rows="10" required
                                ...
                                <div class="col-span-12">
                                    <div
                                        class="justify-start sm:items-center gap-[23px] inline-flex mt-14 flex-col sm:flex-row">
                                        ...
                                        <div class="flex flex-wrap gap-[23px]">
                                            <h4 class="text-black-800 text-xl font-bold font-Syne leading-7">Follow me
                                            </h4>

                                            <ul class="flex flex-wrap gap-x-4 items-center">
                                                <li><a href="#"
                                                        class="text-black-800 transition-all duration-300 hover:text-orange">
                                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                            xmlns="http://www.w3.org/2000/svg">
                                                            <path
                                                ...
                                                <li><a href="#"
                                                        class="text-black-800 transition-all duration-300 hover:text-orange"><svg
