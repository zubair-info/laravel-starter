    ...
    <section class="bg-secondary py-[120px]">
        <div class="container">
            <div class="grid grid-cols-12 gap-6">
                ...
                <div v-for="pot in portfolios" :key="pot.id" class="col-span-12 md:col-span-6" data-aos="fade-up"
                    data-aos-delay="300">
                    <div class="rounded-[20px] overflow-hidden mb-6">
                        <img :src="pot.image_url" alt="project1">
                    </div>
                    <div class="flex flex-wrap flex-col gap-3">
                        <div class="flex flex-wrap gap-2">
                            <Link :href="route('projects_details', { slug: pot.slug })"
                        ...
                        <div class="flex flex-wrap items-center justify-between text-black-800 hover:text-orange group">
                            <h4
                                ...
                                <Link :href="route('projects_details', { slug: pot.slug })" class="transition-all">{{
                                pot.title }}</Link>
                            </h4>
                            <Link :href="route('projects_details', { slug: pot.slug })"
...
<!--
            <div class="col-span-12 mt-12" data-aos="fade-up">
                <div class="flex group">
                    <Link :href="sfdfds" class="flex items-center justify-center flex-wrap btn-primary grow">
                    View All Project
