        ...
        <div class="container">
            <div class="overflow-x-hidden" data-aos="flip-down">
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-6">
                    <div class="pt-12">
                        ...
                        <div class="flex flex-wrap items-center mt-10">
                            <span class="text-xl font-bold font-Syne text-white">{{ about.location }}</span>
                            <div class="ml-5 md:ml-[5px] lg:ml-0 xl:ml-[16px] 2xl:ml-5">
                                <ul class="flex flex-wrap gap-x-4 items-center">
                                    ...
                                    <li><a href="#" class="text-white hover:text-orange"><svg width="24" height="24"
                    ...
                    <div class="py-9 px-7 border-border-white border rounded-2xl flex flex-col justify-between group">
                        <h3 class="text-xl font-bold font-Syne text-white">Looking for a hectic developer?
                        </h3>
                        <div class="flex justify-between items-center">
                            ...
                            <a href="#" class="text-white group-hover:animate-arrow-move-up group-hover:text-orange">
                                <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path d="M11.6667 28.3334L28.3334 11.6667" stroke="currentColor" stroke-width="1.5"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M11.6667 11.6667H28.3334V28.3334" stroke="currentColor" stroke-width="1.5"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                    ...
                    <div class="py-9 px-7 border-border-white border rounded-2xl flex flex-col justify-between group">
                        <h3 class="text-xl font-bold font-Syne text-white">Want a more in-depth look at my
                            history?</h3>
                        <div class="flex justify-between items-center">
                            <p class="text-2xl font-bold font-Syne leading-none text-orange">{{ about.phone }}
                            </p>
                            <a href="#" class="text-white group-hover:animate-arrow-move-up group-hover:text-orange">
                                <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="grid grid-cols-1 gap-6">
                    <div class="py-[72px]">
                        <!-- <svg class="w-full" width="1281" height="77" viewBox="0 0 1281 77" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                ...
                <div class="border-t border-border-white pt-6 ">
                    <div class="grid grid-cols-12">
                        ...
                        <div class="col-span-12 sm:col-span-8 order-last sm:order-first">
                            <p class="text-white text-lg font-normal font-sans leading-7">©2023 {{ about.name }},
                                All
                                Rights Reserved
                            </p>
                        </div>
                        <div class="col-span-12 sm:col-span-4 order-first sm:order-last">
                            <div class="flex justify-end mb-2 sm:mb-0">
                                <a id="scrollUp" class="flex flex-wrap items-center gap-2 group" href="#"
